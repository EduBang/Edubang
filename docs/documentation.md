...
À noter que _pour Windows_, les touches **Contrôle** (Ctrl), **Alternative** (Alt), **Delete** (Del), **Tabulation** (Tab), **Espace** sont supportées. <br/>
Vous pouvez faire une association de touche en les combinants.

> Exemple: Ctrl + S, Alt + Del, Ctrl + Alt + Espace, etc.

_Pour MacOS_, les touches **Commande** (Cmd), **Alternative** (Alt), **Tabulation** (Tab), **Espace** sont aussi supportées.
