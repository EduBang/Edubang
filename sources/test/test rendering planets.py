...
from sources.shared.components.Perlin import Perlin
...
def generate_texture():
    perlin_instance = Perlin.new(surface_size=radius * 2, center_pos=planet_pos, intensity=255, stretching=(7, 7), zoom=4)
