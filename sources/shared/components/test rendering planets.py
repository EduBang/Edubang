...
def generate_texture():
    perlin_instance = Perlin(surface_size=radius * 2, center_pos=planet_pos, intensity=255, stretching=(7, 7), zoom=4)
...
while running:
    ...
    screen.blit(a.image, (planet_pos[0] - radius, planet_pos[1] - radius))
